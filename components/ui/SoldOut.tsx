 ...
 *
 * - SoldOutBand: 写真の上に被せる墨の帯（白抜き「SOLD OUT」）。写真側は `.sold-out-photo`
 *   （app/globals.css）で**色を抜いて少し沈める**。透かして薄くすると、白い皿・白い料理の
 *   写真が白飛びして「画像が無い」ように見えるため（2026-09-12 に本番の実物で確認して変更）。
