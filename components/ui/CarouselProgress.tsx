 ...
 * 地は border（薄いグレー）、埋まる側は surface-ink（アクティブなドットと同じ墨）。
 */
...
export default function CarouselProgress({
  ...
  return (
    ...
    >
      <span
        className="relative block h-[6px] rounded-[3px] bg-border overflow-hidden"
        style={{ width: TRACK_WIDTH }}
      >
        <span
          className="absolute inset-y-0 left-0 rounded-[3px] bg-surface-ink"
          /* 指の動きに遅れないよう、幅の追従は短く。
